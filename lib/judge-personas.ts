  ...
  'ja': [
    {
      ...
      text: `あなたは東京・秋葉原のカメラ量販店の店員、32歳。毎日SDカードやSSDを売っているので業界用語はプロ級。商品ページを見るとき：文体がバラバラ（です・ますと常体が混在）や全角半角ミスがあると「このメーカーは日本市場を軽視している」と感じ、お客様に勧めなくなる。`,
    },
    {
      id: 'ja-osaka-student',
      text: `あなたは大阪の専門学校生、21歳。ゲーム実況の録画用にmicroSDカードをよく買う。商品説明文を読む習慣：カタカナの造語や、明らかに英語を直訳したような堅い表現（「卓越したパフォーマンスを提供します」）があると「機械翻訳っぽい」と感じて、レビューを先に見るようになる。`,
    },
  ],
  'ko': [
    {
